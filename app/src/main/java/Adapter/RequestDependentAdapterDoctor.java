 ...
 */
public class RequestDependentAdapterDoctor extends BaseAdapter {
    ...
    public RequestDependentAdapterDoctor(Activity activity, ArrayList<Patient> patients)
    {
    ...
    public View getView(int position, View cv, ViewGroup parent) {
        ...
        request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                   ...
                   add.setPatientId(doctorId);
                   add.setParents(depends);

                   System.out.println("Add Object:::::::"+add);
                   api.confirmOrDenyParentDoctor(add,new Callback<Response>() {
                       @Override
