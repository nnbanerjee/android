 ...
 */
//Check Login User
public class Doctor_AllPatientAppointmentAdapter extends ArrayAdapter<ClinicAppointment> {
    ...
    public Doctor_AllPatientAppointmentAdapter(Activity context, List<ClinicAppointment> clinicAppointment) {
        ...
        if (convertView == null) {
            ...
            mHolder.layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    editor.putString("doctor_patient_appointmentDate", clinicAppointment.get(position).getAppointmentDate());
                    editor.putString("doctor_patient_appointmentTime", clinicAppointment.get(position).getBookTime());
                    editor.commit();
