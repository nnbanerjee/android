...
//Doctor Login
public class ClinicPatientAdapter extends ArrayAdapter<ClinicDetailVm> {
   ...
   public ClinicPatientAdapter(Activity context, List<ClinicDetailVm> clinicDetailVm) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            final String patient_email = session.getString("patient_email", null);
            final String doctorId = session.getString("sessionID", null);
            ...
            mHolder.visited1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ClinicDetailVm vm = clinicDetailVm.get(clinicPosition);
                    progress = ProgressDialog.show(context, "", "Loading...Please wait...");
                    saveVisitedData(doctorId,patient_email,vm.getClinicId(), "shift1", 1);
                }
            });
            ...
            mHolder.visited2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ClinicDetailVm vm = clinicDetailVm.get(clinicPosition);
                    progress = ProgressDialog.show(context, "", "Loading...Please wait...");
                    saveVisitedData(doctorId,patient_email,vm.getClinicId(), "shift2", 1);
                }
            });
            ...
            mHolder.visited3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ClinicDetailVm vm = clinicDetailVm.get(clinicPosition);
                    progress = ProgressDialog.show(context, "", "Loading...Please wait...");
                    saveVisitedData(doctorId,vm.getDoctorId(),vm.getClinicId(), "shift3", 1);
                }
            });
            ...
            mHolder.notVisited1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ClinicDetailVm vm = clinicDetailVm.get(clinicPosition);
                    progress = ProgressDialog.show(context, "", "Loading...Please wait...");
                    saveVisitedData(doctorId,patient_email,vm.getClinicId(), "shift1", 0);
                }
            });
            ...
            mHolder.notVisited2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ClinicDetailVm vm = clinicDetailVm.get(clinicPosition);
                    progress = ProgressDialog.show(context, "", "Loading...Please wait...");
                    saveVisitedData(doctorId,patient_email,vm.getClinicId(), "shift2", 0);
                }
            });
            ...
            mHolder.notVisited3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ClinicDetailVm vm = clinicDetailVm.get(clinicPosition);
                    progress = ProgressDialog.show(context, "", "Loading...Please wait...");
                    saveVisitedData(doctorId,patient_email,vm.getClinicId(), "shift3", 0);
                }
            });
            ...
            mHolder.clinicName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    int clinicPosition = (Integer) v.getTag();
                    ClinicDetailVm vm = clinicDetailVm.get(clinicPosition);
                    System.out.println("ClinicID= "+vm.getClinicId());
