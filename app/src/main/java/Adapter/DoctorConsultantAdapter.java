...
//Patient Login
public class DoctorConsultantAdapter extends ArrayAdapter<ClinicDetailVm> {
   ...
   public DoctorConsultantAdapter(Activity context, List<ClinicDetailVm> clinicDetailVm) {
        ...
        if (convertView == null) {
            ...
            mHolder.visited1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    saveVisitedData(clinicDetailVm.get(position).getDoctorId(),userId,clinicDetailVm.get(position).getClinicId(), "shift1", 1);
                }
            });
            ...
            mHolder.visited2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    progress = ProgressDialog.show(context, "", "Loading...Please wait...");
                    saveVisitedData(clinicDetailVm.get(position).getDoctorId(),userId,clinicDetailVm.get(position).getClinicId(), "shift2", 1);
                }
            });
            ...
            mHolder.visited3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    progress = ProgressDialog.show(context, "", "Loading...Please wait...");
                    saveVisitedData(clinicDetailVm.get(position).getDoctorId(),userId,clinicDetailVm.get(position).getClinicId(), "shift3", 1);
                }
            });
            ...
            mHolder.notVisited1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    progress = ProgressDialog.show(context, "", "Loading...Please wait...");
                    saveVisitedData(clinicDetailVm.get(position).getDoctorId(),userId,clinicDetailVm.get(position).getClinicId(), "shift1", 0);
                }
            });
            ...
            mHolder.notVisited2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    progress = ProgressDialog.show(context, "", "Loading...Please wait...");
                    saveVisitedData(clinicDetailVm.get(position).getDoctorId(),userId,clinicDetailVm.get(position).getClinicId(), "shift2", 0);
                }
            });
            ...
            mHolder.notVisited3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    progress = ProgressDialog.show(context, "", "Loading...Please wait...");
                    saveVisitedData(clinicDetailVm.get(position).getDoctorId(),userId,clinicDetailVm.get(position).getClinicId(), "shift3", 0);
                }
            });
            ...
            mHolder.nextChange1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getClinicAppointment(clinicDetailVm.get(position).getClinicId(), "shift1", clinicDetailVm.get(position).getAppointmentTime(), clinicDetailVm.get(position).getAppointmentDate());
                }
            });
            ...
            mHolder.nextChange2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getClinicAppointment(clinicDetailVm.get(position).getClinicId(), "shift2", clinicDetailVm.get(position).getAppointmentTime(),clinicDetailVm.get(position).getAppointmentDate());
                }
            });
            ...
            mHolder.bookOnline1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getClinicAppointment(clinicDetailVm.get(position).getClinicId(), "shift1",null,null);
                }
            });
            ...
            mHolder.bookOnline2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getClinicAppointment(clinicDetailVm.get(position).getClinicId(), "shift2",null,null);
                }
            });
            ...
            mHolder.bookOnline3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getClinicAppointment(clinicDetailVm.get(position).getClinicId(), "shift3",null,null);
                }
            });
    ...
    public void getClinicAppointment(String id, String shift, String time, String date){
        ...
        ListView listView = (ListView)context.findViewById(R.id.clinic_doctor_consult_list);
        listView.setVisibility(View.GONE);
        FrameLayout frameLayout = (FrameLayout)context.findViewById(R.id.add_appointment_layout);
        frameLayout.setVisibility(View.VISIBLE);
        //Fragment fragment = new ClinicDoctorAppointmentFragment();
        Fragment fragment = new DoctorConsultantAddAppointmentFragment();
        fragment.setArguments(args);
        FragmentManager fragmentManger = context.getFragmentManager();
        fragmentManger.beginTransaction().replace(R.id.add_appointment_layout,fragment,"Doctor Consultations").addToBackStack(null).commit();
    }
