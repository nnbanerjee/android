 ...
 */
public class AllTemplateAdapter extends ArrayAdapter<AllTemplateVm> {

    public List<AllTemplateVm> allTemplate;
    public final Activity context;
    public SharedPreferences session;

   public AllTemplateAdapter(Activity context, List<AllTemplateVm> allTemplate) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        HorizontalTemplateListAdapter hrAdapter = new HorizontalTemplateListAdapter(context,allTemplate.get(position).templates);
