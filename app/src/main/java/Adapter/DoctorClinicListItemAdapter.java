...
//Patient Login
public class DoctorClinicListItemAdapter extends ArrayAdapter<ClinicDetailVm> {
   ...
   public DoctorClinicListItemAdapter(Activity context, List<ClinicDetailVm> clinicDetailVm) {
