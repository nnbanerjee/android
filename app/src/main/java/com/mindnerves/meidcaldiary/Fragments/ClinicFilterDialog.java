 ...
 */
public class ClinicFilterDialog extends DialogFragment {
    ...
    TextView genderText;
    static ClinicFilterDialog newInstance() {
        return new ClinicFilterDialog();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bun.putSerializable("clinics", sortList());
                ...
                ClinicFilterDialog.this.getDialog().cancel();
            }
        });
