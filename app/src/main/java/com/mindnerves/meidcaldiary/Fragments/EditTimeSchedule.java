 ...
 */
public class EditTimeSchedule extends Fragment {
    ...
    private ArrayList<Schedule> arrayShift1, arrayShift2,arrayShift3, totalArrayShift, editedArrayList;
    ...
    private RelativeLayout layout,layoutShift3;
    private int shiftFlag1 = 0;
    private int shiftFlag2 = 0;
    private int shiftFlag3 = 0;
    private MyApi api;
        ...
        getView().setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (event.getAction() == KeyEvent.ACTION_UP && keyCode == KeyEvent.KEYCODE_BACK) {
                    Fragment frag2 = new ShowTimeSchedule();
                    Bundle bun = new Bundle();
                    bun.putString("clinicId",clinicId);
                    bun.putString("doctorId",doctorId);
                    bun.putSerializable("totalShift",totalArrayShift);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final String clinicId = bun.get("clinicId").toString();
        final String doctorId = bun.get("doctorId").toString();
        ...
        frmhr2 = (Spinner) view.findViewById(R.id.hourfrom3);
        frmmn2 = (Spinner) view.findViewById(R.id.minutefrom3);
        fram2 = (Spinner) view.findViewById(R.id.ampmfrom3);
        ...
        layoutShift3 = (RelativeLayout) view.findViewById(R.id.thirdshift);
        layoutShift3.setVisibility(View.INVISIBLE);

        ImageButton addShift3 = (ImageButton) view.findViewById(R.id.add_shift3);
        addShift3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                layoutShift3.setVisibility(View.VISIBLE);
                if(shiftFlagOnOff == 0)
                {
                    shiftFlagOnOff = 1;
                }
        ...
        ImageButton removeShift3 = (ImageButton)view.findViewById(R.id.remove1);
        removeShift3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                layoutShift3.setVisibility(View.INVISIBLE);
                if(shiftFlagOnOff == 1)
            ...
            public void onClick(View v) {
                ...
                try
                {
                    ...
                    if((shiftFlag1 == 1)||(shiftFlag2 == 2)||(shiftFlag3 == 3)) {
                       ...
                       /* api.addTimeSchedule(toc, new Callback<Response>() {
                            @Override
                            public void success(Response response, Response response2) {
                                ...
                                if (status == 200) {
                                    ...
                                    bun1.putSerializable("totalShift", totalArrayShift);
    ...
    public void showCheckBoxes3(ArrayList<Schedule> array)
    {
        ...
        System.out.println("Shift3 "+fromTime3+" "+toTime3);

        String[] timeFrom3 = fromTime3.split(" ");
        String[] timeFromHoursMins3 = timeFrom3[0].split(":");
        spinnerPosition = hourad1.getPosition(timeFromHoursMins3[0]);
        frmhr3.setSelection(spinnerPosition);
        spinnerPosition = 0;
        spinnerPosition = minad1.getPosition(timeFromHoursMins3[1]);
        frmmn3.setSelection(spinnerPosition);
        spinnerPosition = 0;
        spinnerPosition = ampmtoAdapter1.getPosition(timeFrom3[1]);
        fram3.setSelection(spinnerPosition);
        spinnerPosition = 0;

        String[] timeTo3 = toTime3.split(" ");
        String[] timeToHoursMins3 = timeTo3[0].split(":");
        spinnerPosition = hourad2.getPosition(timeToHoursMins3[0]);
        tohr3.setSelection(spinnerPosition);
        spinnerPosition = 0;
        spinnerPosition = minad2.getPosition(timeToHoursMins3[1]);
        tomn3.setSelection(spinnerPosition);
        spinnerPosition = 0;
        spinnerPosition = ampmtoAdapter2.getPosition(timeTo3[1]);
