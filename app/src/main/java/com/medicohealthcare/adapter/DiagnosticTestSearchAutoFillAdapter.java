...
public class DiagnosticTestSearchAutoFillAdapter extends BaseAdapter
{
    List<Medicine> medicineList;
    Fragment fragment;
    public DiagnosticTestSearchAutoFillAdapter(Fragment fragment, List<Medicine> medicineList)
    {
